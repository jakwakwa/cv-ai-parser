...
export const figmaMappingConfig = z.object({
  ...
  fieldMappings: z.record(z.string(), z.object({
    ...
    transform: z.enum(['none', 'uppercase', 'lowercase', 'capitalize', 'truncate', 'format']).optional(),
  ...
  // Section mappings
  sectionMappings: z.record(z.string(), z.object({
