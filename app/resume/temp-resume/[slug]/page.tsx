...
export default function TempResumePage() {
	...
	const [aiTailorCommentary, setAiTailorCommentary] = useState<string | null>(null)
	const [sourceTool, setSourceTool] = useState<"ai-resume-generator" | "ai-resume-tailor">("ai-resume-tailor")
	...
	if (!resumeData) {
		return (
			<div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-6">
				<h2 className="text-xl font-semibold text-gray-800 mb-4">Resume Not Found. The temporary resume may have expired.</h2>
				<p className="text-gray-600 mb-6 text-center">Please create a new resume or sign up to save resumes permanently.</p>
				<Button
					onClick={() => {
			...
			<div className={styles.container}>
				...
				{KEEP_TEMP_RESUMES_FOR_TESTING && (
					<div
						...
						<span>🧪 Testing Mode: Resume data persists (KEEP_TEMP_RESUMES_FOR_TESTING = true)</span>
						<Button
							size="sm"
							variant="outline"
							onClick={() => {
								if (typeof slug === "string") {
									removeTempResume(slug)
									const toolPath = sourceTool === "ai-resume-generator" ? "/tools/ai-resume-generator" : "/tools/ai-resume-tailor"
