				...
				<div
					...
					{experienceCount > 0 && (
						<div
							...
							<div style={{ fontSize: 36, fontWeight: "bold" }}>{experienceCount}</div>
							<div style={{ fontSize: 18, opacity: 0.9 }}>Experience{experienceCount !== 1 ? "s" : ""}</div>
						</div>
					)}
					...
					{skillsCount > 0 && (
						<div
							...
							<div style={{ fontSize: 36, fontWeight: "bold" }}>{skillsCount}</div>
							<div style={{ fontSize: 18, opacity: 0.9 }}>Skill{skillsCount !== 1 ? "s" : ""}</div>
						</div>
					)}
				</div>
