          ...
          <header className={styles.header}>
            ...
            <div className={styles.topicsGrid}>
              <div className={styles.topicCard}>
                ...
                <ul>
                  <li><strong>Professional summary optimization</strong></li>
                  <li><strong>Achievement quantification techniques</strong></li>
                  <li><strong>Industry-specific formatting strategies</strong></li>
                ...
                <ul>
                  <li><strong>ATS compatibility best practices</strong></li>
                  <li><strong>Keyword research and integration</strong></li>
                  <li><strong>Digital portfolio development</strong></li>
                  <li><strong>Online presence optimization</strong></li>
                </ul>
              </div>
              ...
              <div className={styles.topicCard}>
                ...
                <ul>
                  <li><strong>Career goal setting and planning</strong></li>
                  <li><strong>Professional skill development</strong></li>
                  <li><strong>Networking strategies and relationship building</strong></li>
                  <li><strong>Leadership development pathways</strong></li>
                </ul>
              </div>
              ...
              <div className={styles.topicCard}>
                ...
                <ul>
                  <li><strong>Interview preparation methodologies</strong></li>
                  <li><strong>Behavioral question frameworks</strong></li>
                  <li><strong>Salary negotiation strategies</strong></li>
                  <li><strong>Post-interview follow-up techniques</strong></li>
                </ul>
              </div>
            </div>
          </section>
