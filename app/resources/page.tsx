...
const guides: GuideMeta[] = [
    {
        ...
        description: "Step-by-step guide to instantly build a brand new beautiful designed resume from a text/PDF file.",
    ...
    return (
        <div className={styles.content}>
            ...
            <ul className={styles.guideList}>
                {filtered.map((g) => (
                    <li key={g.slug}>
                        <Link href={g.slug === "posts" ? "/resources/posts" : `/resources/guides/${g.slug}`} className={styles.guideItemTitle}>
                            {g.title}
                        </Link>
