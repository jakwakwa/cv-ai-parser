      ...
      <div className="container mx-auto p-4 max-w-4xl flex-1">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <p className="mb-2">
            ...
            advertising campaigns). We also utilize Google AdSense and other
            third-party advertising partners to serve ads on our site, which may
            use cookies and similar technologies to collect information about
            your browsing activities to provide you with personalized
            advertisements.
          </p>
