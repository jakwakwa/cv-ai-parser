      ...
      <div className="container mx-auto p-4 max-w-4xl flex-1">
        <div className=" rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <p className="mb-2">
            ...
            on this Website, under these Terms, airesumegen.com and/or its
          ...
          <p className="mb-2">
            In no event shall airesumegen.com, nor any of its officers,
            ...
            airesumegen.com, including its officers, directors and employees
            shall not be liable for any indirect, consequential or special or
            exemplary damages arising out of or in any way related to your use
            of this Website.
          </p>
          ...
          <p className="mb-2">
            ...
            airesumegen.com and you in relation to your use of this Website, and
          ...
          <p className="mb-2">
            ...
            laws of the State of South Africa, and you submit to the
            non-exclusive jurisdiction of the state and federal courts located
            in South Africa for the resolution of any disputes.
          </p>
        </div>
      </div>
    </div>
