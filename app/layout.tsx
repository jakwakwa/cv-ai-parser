...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Resume Generator & Jobfit Tailor Tool - Convert to PDF with Custom Colors",
    description:
  ...
  twitter: {
    ...
    title:
      "Easily and quickly create new modern resumés from your existing resume or tailor them to multiple job specifications.",
    description:
