      ...
      <div className={styles.wrapper}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Here you can view all your saved resumes. You can view, share, or
            set each resume to private or public. To edit a resume, click "View"
            and then select "Edit Resume."
          </p>
                    ...
                    <AccordionItem value="intro">
                      <AccordionTrigger className={styles.accordionTrigger}>
                        <h3 className={styles.sectionTitle}>
                          Professional Resume Management Made Simple
                        </h3>
                      </AccordionTrigger>
                      <AccordionContent className={styles.accordionContent}>
                        <div className={styles.accordionInner}>
                          <p className={styles.sectionText}>
                            Your resume library is the central hub for managing
                            all your professional documents. Store multiple
                            versions of your resume, each tailored for different
                            industries, job types, or career stages. Our
                            intelligent organization system helps you track
                            performance metrics, manage visibility settings, and
                            maintain a comprehensive portfolio of your
                            professional presence. With advanced analytics and
                            sharing controls, you can optimize your job search
                            strategy and present the right version of your
                            professional story to each opportunity.
                          </p>
                        </div>
                      </AccordionContent>
                    </AccordionItem>
                ...
                <section className={styles.featuresSection}>
                  ...
                  >
                    <AccordionItem value="features">
                      <AccordionTrigger className={styles.accordionTrigger}>
                        <h3 className={styles.sectionTitle}>
                          Smart Resume Organization Features
                        </h3>
                      </AccordionTrigger>
                      <AccordionContent className={styles.accordionContent}>
                        <div className={styles.accordionInner}>
                          <div className={styles.featuresList}>
                            <div className={styles.featureItem}>
                              ...
                              different resume versions with automatic
                              timestamping and clear naming conventions.
                            </div>
                            <div className={styles.featureItem}>
                              <strong>Performance Analytics:</strong> Monitor
                              view counts and download metrics to understand
                              which resumes generate the most interest.
                            </div>
                            <div className={styles.featureItem}>
                              <strong>Privacy Controls:</strong> Toggle between
                              public and private sharing settings to control
                              your professional visibility.
                            </div>
                            <div className={styles.featureItem}>
                              <strong>Easy Sharing:</strong> Generate shareable
                              links for public resumes and track engagement with
                              potential employers.
                            </div>
                          </div>
                        </div>
                ...
                <section className={styles.bestPracticesSection}>
                  ...
                  >
                    <AccordionItem value="best-practices">
                      <AccordionTrigger className={styles.accordionTrigger}>
                        <h3 className={styles.sectionTitle}>
                          Resume Library Best Practices
                        </h3>
                      </AccordionTrigger>
                      <AccordionContent className={styles.accordionContent}>
                        <div className={styles.accordionInner}>
                          <h4 className={styles.accordionSubtitle}>
                            Maximize Your Job Search Success
                          </h4>
                          <p className={styles.sectionText}>
                            Maximize your job search success by organizing your
                            resumes strategically. Create industry-specific
                            versions that highlight relevant skills and
                            experiences. Use descriptive names that reflect the
                            target role or company. Regularly update your
                            resumes with new achievements and skills. Keep both
                            public versions for networking and private versions
                            for sensitive applications.
                          </p>

                          <h4 className={styles.accordionSubtitle}>
                            Monitor Your Resume Performance
                          </h4>
                          <p className={styles.sectionText}>
                            Monitor your resume performance metrics to
                            understand which versions generate the most
                            interest. Public resumes with higher view counts
                            often indicate content that resonates with your
                            target audience. Use this data to refine your other
                            resume versions and improve your overall job search
                            effectiveness.
                          </p>
                        </div>
                      </AccordionContent>
