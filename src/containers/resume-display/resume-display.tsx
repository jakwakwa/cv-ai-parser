...
const ResumeDisplay: React.FC<ResumeDisplayProps> = ({ resumeData }) => {
	...
	return (
		<div id="resume-content" className={styles.resumeContent} ref={resumeContainerRef}>
			<ProfileHeader
			...
			<div className={styles.resumeGrid}>
				<div className={styles.resumeSidebar}>
					<ContactSection contact={resumeData.contact || {}} customColors={resumeData.customColors || {}} />
					<EducationSection education={resumeData.education} customColors={resumeData.customColors || {}} />
					<CertificationsSection certifications={resumeData.certifications} customColors={resumeData.customColors || {}} />
					<SkillsSection
				...
				<div className={styles.resumeMainContent}>
					<ExperienceSection experience={resumeData?.experience ? resumeData?.experience : null} customColors={resumeData.customColors || {}} />
				</div>
			</div>
		</div>
	)
