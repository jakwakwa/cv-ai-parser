						...
						<div className={styles.toolsSection}>
							...
							<div className={styles.toolsGrid}>
								<div className={styles.toolCard}>
									...
									<p>Upload your resume and a job description to create a perfectly tailored resume</p>
									<Button onClick={() => router.push("/tools/ai-resume-tailor")}>Try AI Tailor</Button>
								</div>
							</div>
						</div>
					</div>
						...
						<div className={styles.toolsSection}>
							...
							<div className={styles.toolsGrid}>
								<div className={styles.toolCard}>
									...
									<Button onClick={() => router.push("/tools/ai-resume-tailor")}>Try AI Resume Generator</Button>
								</div>
							</div>
						</div>
					</div>
