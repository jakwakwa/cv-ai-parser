...
export async function parseResumeGenerator(formData: FormData, onStreamUpdate?: (update: StreamUpdate) => void): Promise<StreamUpdate> {
...
export async function parseResumeTailor(formData: FormData, onStreamUpdate?: (update: StreamUpdate) => void): Promise<StreamUpdate> {
...
export async function parseResume(formData: FormData, onStreamUpdate?: (update: StreamUpdate) => void): Promise<StreamUpdate> {
	// Default to tailor for backward compatibility
	return parseResumeTailor(formData, onStreamUpdate)
}

async function handleStreamingResponse(response: Response, onStreamUpdate?: (update: StreamUpdate) => void): Promise<StreamUpdate> {
