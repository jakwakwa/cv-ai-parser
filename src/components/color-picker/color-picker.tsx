			...
			<CardContent className={styles.cardContent}>
							...
							<button
								...
								<div className={styles.schemeColorPreview}>
									...
									<div
										className={styles.colorCircle}
										style={{
											backgroundColor: scheme.colors["--resume-sidebar-background"],
										}}
									/>
									<div
										className={styles.colorCircle}
				...
				<div>
					<div className={styles.customColorHeader}>
						...
						<Button variant="outline" size="sm" onClick={handleReset} className={styles.resetButton}>
						...
						<div>
							...
							<div className={styles.colorInputContainer}>
								<input
									id="main-accent"
									type="color"
									value={currentColors["--resume-job-title"] || defaultColors["--resume-job-title"]}
									onChange={e => handleCustomColorChange("--resume-job-title", e.target.value)}
						...
						<div>
							...
							<div className={styles.colorInputContainer}>
								<input
									id="secondary"
									type="color"
									value={currentColors["--resume-main-icons"] || defaultColors["--resume-main-icons"]}
									onChange={e => handleCustomColorChange("--resume-main-icons", e.target.value)}
									className={styles.colorInput}
								/>
								<span className={styles.colorDescription}>Buttons & Main Icons</span>
							</div>
						</div>
						...
						<div>
							...
							<div className={styles.colorInputContainer}>
								<input
									id="text-color"
									type="color"
									value={currentColors["--resume-profile-name"] || defaultColors["--resume-profile-name"]}
									onChange={e => handleCustomColorChange("--resume-profile-name", e.target.value)}
									className={styles.colorInput}
								/>
								<span className={styles.colorDescription}>Profile Name, Section Titles, Dates</span>
							</div>
						</div>

						<div>
							<label htmlFor="profile-header-background" className={styles.colorLabel}>
							...
							<div className={styles.colorInputContainer}>
								<input
									...
									type="color"
									value={currentColors["--resume-profile-header-background"] || defaultColors["--resume-profile-header-background"]}
									onChange={e => handleCustomColorChange("--resume-profile-header-background", e.target.value)}
									className={styles.colorInput}
								/>
								<span className={styles.colorDescription}>Background for Profile Header</span>
							</div>
						</div>
						...
						<div>
							...
							<div className={styles.colorInputContainer}>
								<input
									...
									type="color"
									value={currentColors["--resume-sidebar-background"] || defaultColors["--resume-sidebar-background"]}
									onChange={e => handleCustomColorChange("--resume-sidebar-background", e.target.value)}
									className={styles.colorInput}
								/>
								<span className={styles.colorDescription}>Background for Sidebar</span>
							</div>
						</div>
						...
						<div>
							...
							<div className={styles.colorInputContainer}>
								<input
									id="accent-light"
									type="color"
									value={currentColors["--resume-sub-icons"] || defaultColors["--resume-sub-icons"]}
									onChange={e => handleCustomColorChange("--resume-sub-icons", e.target.value)}
									className={styles.colorInput}
								/>
								<span className={styles.colorDescription}>Highlights & Sub-Icons</span>
							</div>
						</div>
						...
						<div>
							...
							<div className={styles.colorInputContainer}>
								<input
									id="body-text"
									type="color"
									value={currentColors["--resume-body-text"] || defaultColors["--resume-body-text"]}
									onChange={e => handleCustomColorChange("--resume-body-text", e.target.value)}
									className={styles.colorInput}
								/>
								<span className={styles.colorDescription}>Main content text</span>
							</div>
						</div>
						...
						<div>
							...
							<div className={styles.colorInputContainer}>
								<input
									id="skill-border"
									type="color"
									value={currentColors["--resume-skill-border"] || defaultColors["--resume-skill-border"]}
									onChange={e => handleCustomColorChange("--resume-skill-border", e.target.value)}
									className={styles.colorInput}
								/>
								<span className={styles.colorDescription}>Border for skill badges</span>
							</div>
						</div>
					</div>
				</div>
